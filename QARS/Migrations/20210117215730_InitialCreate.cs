        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KMRate = table.Column<decimal>(nullable: false),
                    FreeMileage = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_Users_FranchiseeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationExtras", x => new { x.ReservationId, x.ExtraId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CarLocationId",
                table: "Reservations",
